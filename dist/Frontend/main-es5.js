...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () { this.titre = this.cookieservice.get('titre'); };
...
var CreerFormulaireComponent = /** @class */ (function () {
    function CreerFormulaireComponent(fb, serviceformulaire, params, router) {
        this.fb = fb;
    ...
    CreerFormulaireComponent.prototype.ngOnInit = function () { this.initialise(); };
    CreerFormulaireComponent.prototype.initialise = function () {
        var _this = this;
        ...
        if (action == "Nouveau")
            ...
            this.serviceformulaire.Recherche({ date_creation: action }).subscribe(function (data) {
                if (data.length == 0)
                    _this.router.navigate(['/Acceuil']);
                else {
                    _this.formulaire = data[0];
                    _this.Emailvalidation = data[0].Emailvalidation.split(',');
                    _this.FormData = data[0].donne;
                    _this.action = false;
                }
            });
        }
    ...
    CreerFormulaireComponent.prototype.NouveauChamp = function (type, Nom, min, max, def, complexite) {
    ...
    CreerFormulaireComponent.prototype.changeoblig = function () {
        this.oblig = !this.oblig;
    };
    CreerFormulaireComponent.prototype.changdefchx = function () {
        this.chx_def = !this.chx_def;
    };
    CreerFormulaireComponent.prototype.changesend = function () {
        this.send = !this.send;
    };
    CreerFormulaireComponent.prototype.changemessage = function (mess) {
        this.mess = mess;
    };
    CreerFormulaireComponent.prototype.changedis = function (valeur) {
        this.dis = (valeur.length >= 3) ? false : true;
    };
    CreerFormulaireComponent.prototype.Nouvellist = function (valeur_ls) {
        this.liste.push(valeur_ls);
        this.dis = true;
        this.valid_list = (this.liste.length > 1) ? false : true;
    };
    CreerFormulaireComponent.prototype.supprimer_elem = function (i) {
        this.liste.splice(i, 1);
        this.valid_list = (this.liste.length > 1) ? false : true;
    };
    CreerFormulaireComponent.prototype.supprimer_champ = function (i) {
        this.FormData.splice(i, 1);
    };
    CreerFormulaireComponent.prototype.supprime_admin = function (i) {
        this.Emailvalidation.splice(i, 1);
    };
    CreerFormulaireComponent.prototype.addAdmin = function (email_adm) {
        this.Emailvalidation.push(email_adm);
        this.AjoutEmail.reset();
    };
    CreerFormulaireComponent.prototype.Publie_form = function (titre_formulaire, TitreBouttont, couleurBouttont, action) {
        var _this = this;
        ...
        if (action == 1)
            this.serviceformulaire.Ajouter(formulaire).subscribe(function (data) {
                if (data != 'ko') {
                    _this.uri = data;
                    _this.vu_creation = false;
                    _this.titre_formulaire = titre_formulaire;
                }
                else
            ...
            this.serviceformulaire.Recherche({ titre: titre_formulaire }).subscribe(function (data_r) {
                if (data_r.length > 0 && titre_formulaire != _this.formulaire.titre)
                    sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({ type: "warning", text: "un formulaire portant le même titre existe déjà, veuillez changer de titre." });
                else {
                    _this.formulaire.titre = titre_formulaire;
                    _this.formulaire.Emailvalidation = _this.Emailvalidation.join(',');
                    _this.formulaire.boutton = { Nom: TitreBouttont, Couleur: couleurBouttont };
                    _this.formulaire.donne = _this.FormData;
                    _this.serviceformulaire.Modifier(_this.formulaire).subscribe(function (data) {
                        _this.uri = _this.formulaire.date_creation;
                        _this.vu_creation = false;
                        _this.titre_formulaire = titre_formulaire;
                    });
                }
    ...
    CreerFormulaireComponent.prototype.copier = function (lien) {
        lien.select();
    ...
    CreerFormulaireComponent.ctorParameters = function () { return [
    ...
    return CreerFormulaireComponent;
}());
...
var GererFormulaireComponent = /** @class */ (function () {
    function GererFormulaireComponent(serviceformulaire) {
        this.serviceformulaire = serviceformulaire;
        this.Donnee = [];
        this.Link = "http://demandeinfo.mairie-clichy.fr/#/";
        this.ColumnsInformation = ['Titre', 'Administrateur', 'liena', 'lienp', 'lienSui', 'act'];
    }
    GererFormulaireComponent.prototype.ngOnInit = function () { this.findData(); };
    GererFormulaireComponent.prototype.findData = function () {
        var _this = this;
        this.serviceformulaire.Initialise_titre("Generateur de formulaire electronique");
        this.serviceformulaire.Recherche({}).subscribe(function (data) {
            _this.Donnee = data;
        });
    };
    GererFormulaireComponent.prototype.Supprimer = function (_id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            ...
            if (result.value) {
                _this.serviceformulaire.Supprimer(_id).subscribe(function () {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                        position: 'top-end',
                        type: "success",
                        width: "20%",
    ...
    GererFormulaireComponent.ctorParameters = function () { return [
    ...
    return GererFormulaireComponent;
}());
...
var NouvelDemandeComponent = /** @class */ (function () {
    function NouvelDemandeComponent(serviceformulaire, dataserviceform, params, router) {
        this.serviceformulaire = serviceformulaire;
    ...
    NouvelDemandeComponent.prototype.ngOnInit = function () { this.initialisation(); };
    NouvelDemandeComponent.prototype.initialisation = function () {
        var _this = this;
        this.date_creation = this.params.snapshot.paramMap.get('date_creation');
        this.serviceformulaire.Recherche({ date_creation: this.date_creation }).subscribe(function (data) {
            if (data.length == 0)
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({ type: "error", text: "Ce lien n'est pas valide" }).then(function () { _this.router.navigate(['/Acceuil']); });
            else {
                _this.initialistion_defaultvalue(data[0].donne);
                _this.serviceformulaire.Initialise_titre(data[0].titre);
                _this.titre = data[0].titre;
                _this.formulaire = data[0];
                _this.FormData = data[0].donne;
                _this.style = _this.formulaire.boutton.Couleur;
            }
        });
    };
    NouvelDemandeComponent.prototype.initialistion_defaultvalue = function (data) {
    ...
    NouvelDemandeComponent.prototype.verifie_champs = function () {
        var ret = false;
    ...
    NouvelDemandeComponent.prototype.save_Value = function (type, nomchmp, valeur, oblig, send_text) {
        if (send_text === void 0) { send_text = ""; }
    ...
    NouvelDemandeComponent.prototype.Pdf_downoald = function (code_dem) {
        var img = new Image();
    ...
    NouvelDemandeComponent.prototype.EnregistrerDemande = function () {
        var _this = this;
        ...
        if (verif)
            ...
            this.dataserviceform.Ajouter(data).subscribe(function (data) {
                _this.code_demande = data;
                _this.Pdf_downoald(data);
            });
        }
    };
    NouvelDemandeComponent.prototype.copier = function (lien) {
        lien.select();
        document.execCommand("copy");
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
            position: 'top-end',
    ...
    NouvelDemandeComponent.prototype.acces_valeur = function (nom_chmp) {
        var k = this.nom_tmp.indexOf(nom_chmp);
        return (k == -1) ? null : this.data_form[k].valeur;
    };
    NouvelDemandeComponent.ctorParameters = function () { return [
...
var SuivreDemandeComponent = /** @class */ (function () {
    function SuivreDemandeComponent(serviceformulaire, dataserviceform, fb, router, params) {
        this.serviceformulaire = serviceformulaire;
        this.dataserviceform = dataserviceform;
        this.fb = fb;
        this.router = router;
    ...
    SuivreDemandeComponent.prototype.ngOnInit = function () {
        this.initialisation();
    };
    SuivreDemandeComponent.prototype.initialisation = function () {
        var _this = this;
        this.date_creation = this.params.snapshot.paramMap.get('date_creation');
        ...
        this.serviceformulaire.Recherche({ date_creation: this.date_creation }).subscribe(function (data) {
            if (data.length == 0)
                sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({ type: "error", text: "ce lien n'est pas valide" }).then(function () { _this.router.navigate(['/Acceuil']); });
            else
                _this.FormData = data[0].donne;
            _this.serviceformulaire.Initialise_titre(data[0].titre);
            _this.titre = data[0].titre;
    ...
    SuivreDemandeComponent.prototype.shearch_form = function (valeur) {
        var _this = this;
        this.date_demande = valeur;
        this.dataserviceform.Recherche({ id_form: this.date_creation, dte_dem: valeur }).subscribe(function (data) {
            _this.data_demande = data[0];
            if (data[0] != undefined) {
                _this.data_form = data[0].data;
                _this.Etat = data[0].Date_etat[data[0].Date_etat.length - 1].etat;
                ...
                _this.date_de_demande = event.toLocaleDateString('fr-FR');
                for (var i = 0; i < _this.data_form.length; i++)
                    _this.nom_tmp.push(_this.data_form[i].nom);
            }
        });
    };
    SuivreDemandeComponent.prototype.Pdf_downoald = function (code_dem) {
        if (code_dem === void 0) { code_dem = this.date_demande; }
        var img = new Image();
        img.src = '../../../../assets/img/images.png';
        var img1 = new Image();
        img1.src = '../../../../assets/img/logo.PNG';
    ...
    SuivreDemandeComponent.prototype.acces_valeur = function (nom_chmp) {
        var k = this.nom_tmp.indexOf(nom_chmp);
        return (k == -1) ? null : this.data_form[k].valeur;
    };
    SuivreDemandeComponent.prototype.match = function () {
        return !(typeof this.data_demande == 'undefined');
    };
    SuivreDemandeComponent.ctorParameters = function () { return [
        { type: _services_formulaire_service__WEBPACK_IMPORTED_MODULE_4__["FormulaireService"] },
...
var AuthentificationComponent = /** @class */ (function () {
    function AuthentificationComponent(serviceformulaire, fb, router, params) {
        this.serviceformulaire = serviceformulaire;
        this.fb = fb;
        this.router = router;
        this.params = params;
    ...
    AuthentificationComponent.prototype.ngOnInit = function () { this.initialise(); };
    AuthentificationComponent.prototype.initialise = function () {
        this.date_creation = this.params.snapshot.paramMap.get('date_creation');
    ...
    AuthentificationComponent.prototype.NouveauMDP = function (Email, MDP) {
        var _this = this;
        var data = { date_creation: this.date_creation, Crypto: this.crypto, Email: Email.toLowerCase(), MDP: MDP };
        this.serviceformulaire.NewMDP(data).subscribe(function (data) {
            if (data == 'ok') {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
                    position: 'top-end',
                    width: "50%",
    ...
    AuthentificationComponent.prototype.MDPOublie = function (Email) {
        this.serviceformulaire.Forget(this.date_creation, Email.toLowerCase()).subscribe(function (data) {
            if (data == 'ok') {
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
                    position: 'top-end',
                    width: "50%",
    ...
    AuthentificationComponent.prototype.oublie_act = function () {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
            ...
            if (result.value) {
                _this.MDPOublie(result.value);
            }
        });
    };
    AuthentificationComponent.prototype.Connexion = function (Email, MDP) {
        var _this = this;
        var data = { date_creation: this.date_creation, Email: Email.toLowerCase(), MDP: MDP };
        this.serviceformulaire.Connexion(data).subscribe(function (data) {
            if (data == 'ko1')
                sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
                    position: 'top-end',
                    width: "50%",
            ...
            if (data == 'ko2')
                ...
                _this.serviceformulaire.Initialise_conne(Email, data);
                _this.router.navigate(['/Suivis/' + _this.date_creation]);
            }
        });
    };
    AuthentificationComponent.prototype.Conformite = function (MDP, Confirm) { this.vue_conform = MDP == Confirm; return MDP == Confirm; };
    AuthentificationComponent.prototype.conformiteMDP = function (MDP) {
        var format = /[é&çà%ù£$¨^:!§;,.£ !@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/;
    ...
    AuthentificationComponent.ctorParameters = function () { return [
        { type: _services_formulaire_service__WEBPACK_IMPORTED_MODULE_4__["FormulaireService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
...
var GererDemandeComponent = /** @class */ (function () {
    function GererDemandeComponent(serviceformulaire, dataserviceform, fb, router, params) {
        this.serviceformulaire = serviceformulaire;
        this.dataserviceform = dataserviceform;
        this.fb = fb;
        this.router = router;
    ...
    GererDemandeComponent.prototype.ngOnInit = function () { this.initialise(); };
    GererDemandeComponent.prototype.initialise = function () {
        var _this = this;
        this.date_creation = this.params.snapshot.paramMap.get('date_creation');
        this.date_demande = this.params.snapshot.paramMap.get('date_demande');
        ...
        this.serviceformulaire.Recherche({ date_creation: this.date_creation }).subscribe(function (data) {
            if (data.length == 0)
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({ type: "error", text: "ce lien n'est pas valide" }).then(function () { _this.router.navigate(['/Acceuil']); });
            else {
                _this.FormData = data[0].donne;
                _this.serviceformulaire.Initialise_titre(data[0].titre);
                _this.titre = data[0].titre;
                if (_this.date_demande != "") {
                    _this.shearch_form(_this.date_demande);
                    _this.shearchform.controls.Recherche.setValue(_this.date_demande);
                }
                else
                    _this.shearch_form("", 0, "", 1);
            }
        });
    };
    GererDemandeComponent.prototype.shearch_form = function (val, eta, date, option) {
        var _this = this;
        if (val === void 0) { val = ""; }
        if (eta === void 0) { eta = 0; }
        if (date === void 0) { date = ""; }
        ...
        if (option == 0)
            this.dataserviceform.Recherche({ id_form: this.date_creation, dte_dem: val }).subscribe(function (data) {
                if (data.length > 0)
                    _this.data_demande = data;
                else
                    _this.shearch_form("", 0, "", 1);
            });
        else if (option == 1)
            this.dataserviceform.Recherche({ id_form: this.date_creation }).subscribe(function (data) { _this.data_demande = data; });
        else if (option == 2)
            this.dataserviceform.Recherche_spec({ date_creation: this.date_creation, etat: eta, option: 1 }).subscribe(function (data) {
                if (data.length > 0)
                    _this.data_demande = data;
                else
                    _this.shearch_form("", 0, "", 1);
            ...
            this.dataserviceform.Recherche_spec({ date_creation: this.date_creation, date: date, option: 0 }).subscribe(function (data) {
                if (data.length > 0)
                    _this.data_demande = data;
                else
                    _this.shearch_form("", 0, "", 1);
    ...
    GererDemandeComponent.prototype.getDate = function (dte) {
        var event = new Date(parseInt(dte));
        return event.toLocaleDateString('fr-FR');
    };
    GererDemandeComponent.prototype.getEtat = function (val) {
        return (val == 0) ? "En attente" : (val == 1) ? "Refusé" : (val == 2) ? "Accepté/En cours de traitement" : "traité";
    };
    GererDemandeComponent.prototype.change = function (element, option) {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            ...
            if (result.value) {
                ...
                _this.dataserviceform.Modifier(element).subscribe(function (data) { });
            }
        });
    };
    GererDemandeComponent.prototype.Pdf_downoald = function (element, code_dem) {
        var img = new Image();
        img.src = '../../../../assets/img/images.png';
        var img1 = new Image();
        img1.src = '../../../../assets/img/logo.PNG';
    ...
    GererDemandeComponent.prototype.init_nomchamp = function (elem) {
        var ret = [];
        for (var i = 0; i < elem.length; i++)
            ret.push(elem[i].nom);
        return ret;
    };
    GererDemandeComponent.prototype.acces_valeur = function (nom_chmp, elem) {
        var k = this.init_nomchamp(elem).indexOf(nom_chmp);
        return (k == -1) ? null : elem[k].valeur;
    };
    GererDemandeComponent.prototype.deconnecte = function () {
        this.serviceformulaire.Deconnecte(this.date_creation);
    };
    GererDemandeComponent.ctorParameters = function () { return [
        { type: _services_formulaire_service__WEBPACK_IMPORTED_MODULE_4__["FormulaireService"] },
        { type: _services_data_formulaire_service__WEBPACK_IMPORTED_MODULE_5__["DataFormulaireService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var DataFormulaireService = /** @class */ (function () {
    function DataFormulaireService(http) {
        this.http = http;
        this.uri = 'http://demandeinfo.mairie-clichy.fr:4000';
    }
    DataFormulaireService.prototype.Recherche = function (recherche) {
        return this.http.post(this.uri + "/DataForms", recherche);
    };
    DataFormulaireService.prototype.Recherche_spec = function (recherche) {
        return this.http.post(this.uri + "/DataFormr", recherche);
    };
    DataFormulaireService.prototype.Ajouter = function (formulaire) {
        return this.http.post(this.uri + "/DataForm", formulaire);
    };
    DataFormulaireService.prototype.Modifier = function (formulaire) {
        return this.http.put(this.uri + "/DataForm", formulaire);
    };
    DataFormulaireService.prototype.Supprimer = function (_id) {
        return this.http.delete(this.uri + "/DataForm/" + _id);
    };
    DataFormulaireService.ctorParameters = function () { return [
...
var FormulaireService = /** @class */ (function () {
    function FormulaireService(http, cookieservice, router) {
        this.http = http;
        this.cookieservice = cookieservice;
        this.router = router;
        this.uri = 'http://demandeinfo.mairie-clichy.fr:4000';
    }
    FormulaireService.prototype.Recherche = function (recherche) {
        return this.http.post(this.uri + "/Formulaires", recherche);
    };
    FormulaireService.prototype.Ajouter = function (formulaire) {
        return this.http.post(this.uri + "/Formulaire", formulaire);
    };
    FormulaireService.prototype.Modifier = function (formulaire) {
        return this.http.put(this.uri + "/Formulaires", formulaire);
    };
    FormulaireService.prototype.Supprimer = function (_id) {
        return this.http.delete(this.uri + "/Formulaires/" + _id);
    };
    FormulaireService.prototype.NewMDP = function (data) {
        return this.http.put(this.uri + "/Administrations", data);
    };
    FormulaireService.prototype.Forget = function (date_creation, email) {
        return this.http.get(this.uri + "/Administrations/" + date_creation + '/' + email);
    };
    FormulaireService.prototype.Connexion = function (data) {
        return this.http.post(this.uri + "/Administrations", data);
    };
    FormulaireService.prototype.Access = function (date_creation, date_demande, email, Crypto) {
        var _this = this;
        if (email === void 0) { email = this.cookieservice.get('email'); }
        if (Crypto === void 0) { Crypto = this.cookieservice.get('tempo'); }
        this.http.get(this.uri + "/Administrations/" + date_creation + '/' + email + '/' + Crypto).subscribe(function (data) {
            if (data != "ok")
                _this.router.navigate(['/Administration/' + date_creation]);
            else
                _this.router.navigate(['/Suivis/' + date_creation + '/' + date_demande]);
        });
    };
    FormulaireService.prototype.Deconnecte = function (date_creation) {
        this.cookieservice.removeAll();
        this.router.navigate(['/Administration/' + date_creation]);
    };
    FormulaireService.prototype.Initialise_conne = function (email, Crypto) {
        this.cookieservice.put("email", email);
        this.cookieservice.put("tempo", Crypto);
    };
    FormulaireService.prototype.Initialise_titre = function (titre) { this.cookieservice.put("titre", titre); };
    FormulaireService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
